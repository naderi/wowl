...
const de: Dict = {
  ...
  "field.pixabayKey": "Pixabay API-Schlüssel",
  "field.wallhavenKey": "Wallhaven API-Schlüssel (optional)",
  ...
  "placeholder.pixabayKey": "von pixabay.com/api/docs",
  "placeholder.wallhavenKey": "von wallhaven.cc/settings/account",
  ...
  "hint.wallhavenKey": "Nur für höhere Anfragelimits nötig – die Suche funktioniert auch ohne Schlüssel.",
...
const en: Dict = {
  ...
  "field.wallhavenKey": "Wallhaven API key (optional)",
  ...
  "placeholder.pixabayKey": "from pixabay.com/api/docs",
  "placeholder.wallhavenKey": "from wallhaven.cc/settings/account",
  ...
  "hint.wallhavenKey": "Only needed for higher request limits – search works without a key.",
